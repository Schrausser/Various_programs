...
uses crt; 
var stnr: string [3]; 
var p1name,p2name,tsname: string [30]; 
var stp1,stp2: string [7]; 
...
begin     
str (I,stnr);    
p1name:=concat('c:\simul3\plager\p1z',stnr,'.lst');     
p2name:=concat('c:\simul3\plager\p2z',stnr,'.lst');     
...
val(stp2,p2,code);         
p2:=(int(10000*p2));                
if p1>500 then stark05e := stark05e + 1;                        
if p1>1000 then stark10e := stark10e + 1;         
...
if p2>2000 then kv20z1 := kv20z1 + 1;            
anzahl:=anzahl+1;            
end                         
else                                                        
begin            
...
close (p1datei);     
close (p2datei);                                                                                                                            
writeln (tsdatei,'Zelle ',I,': Alpha=0.05; einseitig;  TS=',((1000stark05e)/1000):7:5); 
...
writeln (tsdatei,'Zelle ',I,': Alpha=0.10; einseitig;  TS = ',((500-kv10e1)/500):7:5,' / ',((500-kv10e2)/500):7:5);     
writeln (tsdatei,'Zelle ',I,': Alpha=0.20; einseitig;  TS = ',((500-kv20e1)/500):7:5,' / ',((500-kv20e2)/500):7:5);     
writeln (tsdatei);     
writeln (tsdatei,'Zelle ',I,': Alpha=0.05; zweiseitig; TS = ',((500-kv05z1)/500):7:5,' / ',((500-kv05z2)/500):7:5);     
writeln (tsdatei,'Zelle ',I,': Alpha=0.10; zweiseitig; TS = ',((500-kv10z1)/500):7:5,' / ',((500-kv10z2)/500):7:5);     
writeln (tsdatei,'Zelle ',I,': Alpha=0.20; zweiseitig; TS = ',((500-kv20z1)/500):7:5,' / ',((500-kv20z2)/500):7:5);     
writeln (tsdatei);     
end;                       
close (tsdatei); 
end.  
